...
def get_loaders(scaler, batch_size=32, num_workers=2, pad_range=(40, 50), time_range=(265, 280), strict=False):
    ...
    test_dataset = MyDataset(Y_test, preprocess_features(X_test_raw.astype('float32')))

    train_loader = DataLoader(train_dataset, batch_size=batch_size, num_workers=num_workers, pin_memory=True)
    test_loader = DataLoader(test_dataset, batch_size=batch_size, num_workers=num_workers, pin_memory=True)

    return train_loader, test_loader, X_test_raw, Y_test
